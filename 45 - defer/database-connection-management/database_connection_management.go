...
func realizarConsulta() error {
	...
	//db, err := sql.Open("mysql", "freedb_fluentcode:SgtM7Z%3WZksyuD@tcp(sql.freedb.tech:3306)/freedb_defer_example")
	db, err := sql.Open("mysql", "root:mysql123456@/defer_example")
	if err != nil {
